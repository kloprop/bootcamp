...
public class DataBase {
  List<Department> allRecord;

  public DataBase() {
    this.allRecord = new ArrayList<>();
  }

  public void add(Department list) {
  ...
  public static void main(String[] args) {
    Department<ITStaff> it = Department.of(DepartmentName.IT,
    ...
    Department<SalesStaff> sales = Department.of(DepartmentName.SALES,
