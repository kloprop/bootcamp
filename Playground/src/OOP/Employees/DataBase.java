...
public class DataBase {
  List<ListsFactory> allRecord;

  public DataBase() {
    this.allRecord = new ArrayList<>();
  }

  public void add(ListsFactory list) {
  ...
  public static void main(String[] args) {
    ListsFactory<ITStaff> it = ListsFactory.of(Department.IT,
    ...
    ListsFactory<SalesStaff> sales = ListsFactory.of(Department.SALES,
