...
public class JavaQuest35 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(moveZeroes(new int[] { 0, 0, 0, 3, 12 }));// [1,3,12,0,0]
    System.out.println(moveZeroes(new int[] { 0, 1, 0, 0, 12 }));// [1,3,12,0,0]
    System.out.println(moveZeroes(new int[] { 0, 1, 0, 0, 0}));// [1,3,12,0,0]
